...
class price_record(osv.osv):
    ...
    _columns = {
        ...
        'information_date_from':fields.function(lambda *a,**k:{}, method=True, type='date',string="Price date from"),
        'information_date_to':fields.function(lambda *a,**k:{}, method=True, type='date',string="Price date to"), 
    }
